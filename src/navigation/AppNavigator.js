  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="AuthScreen" screenOptions={{ headerStyle: { backgroundColor: '#0A2540' }, headerTintColor: '#fff', headerTitleStyle: { fontWeight: '700' } }}>
        ...
        <Stack.Screen name="HomeScreen" component={HomeScreen} options={{ title: 'JustSPAI' }} />
        ...
        <Stack.Screen name="SubscriptionScreen" component={SubscriptionScreen} options={{ title: 'Premium Plans' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
